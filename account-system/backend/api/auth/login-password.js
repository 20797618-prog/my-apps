// POST /api/auth/login-password -> 邮箱 + 6 位数字密码登录（密码未设置则提示走验证码）
// 防爆破：同一邮箱连续错误 PWD_LOCK_MAX 次锁定 PWD_LOCK_TTL 秒。
import { json, handleOptions, validEmail, normEmail, verifyPassword, validPassword, randomHex, SESSION_TTL, PWD_LOCK_MAX, PWD_LOCK_TTL } from '../../_account_lib.js';
