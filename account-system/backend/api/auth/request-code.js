...
// 账号数据存中央账号库 ACCOUNTS_KV；未配置 SMTP 时进入开发模式直接返回验证码。
import { corsHeaders, json, handleOptions, validEmail, normEmail, safeEqual, randomCode, CODE_TTL, RATE_TTL } from '../../_account_lib.js';
